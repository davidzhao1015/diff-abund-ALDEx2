...
-   dif.btw median difference in clr values beween VdrFecal and VdrCecal
    groups
-   dif.win median of the largest difference in clr values within
    VdrFecal and VdrCecal groups
-   effect median effect size: diff.btw/max(diff.win) for all instances
-   overlap proportion of effect size that overlaps 0: it is overlap
    between the Bayesian distribuiotn of rous VdrFecal and VdrCecal
